...
for i in [2, 3, 4, 5, 8, 16]:
    for j in [2, 3, 4, 5, 8, 16, 32]:
        sample_filename = '/raid/lingo/abau/random-walks/testset-%d-%d-0/small_sample' % (i, j)
        ...
        for l in [2, 4, 8, 16, 32, 64, 128]:
            ...
            output_filename = '/raid/lingo/abau/random-walks/lstm-%d-%d-0-%d/sample-annotated.json' % (i, j, l)
